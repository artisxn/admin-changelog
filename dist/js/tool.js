                ...
                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                    while (1) {
                        switch (_context.prev = _context.next) {
                            case 0:
                                _context.next = 2;
                                return Nova.request().get("/nova-vendor/admin-changelog/changelog");

                            case 2:
                                this.changelog = _context.sent.data;
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Changelog")]),
      _vm._v(" "),
      _c("card", {
        staticClass: "p-6",
        staticStyle: { "min-height": "300px" },
        domProps: { innerHTML: _vm._s(_vm.changelog) }
      })
    ],
    1
  )
